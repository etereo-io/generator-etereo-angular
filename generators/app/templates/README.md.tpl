![Codeship Status for etereo/<%= appName %>](https://codeship.com/projects/projectid/status?branch=master)


# Project Management

* [CI](https://codeship.com/projects/projectid)
* [GIT](https://bitbucket.org/etereo/<%= appName %>)
* [Kanban](https://tree.taiga.io/project/<%= appName %>/backlog)
* [Chat](https://etereo.slack.com/messages/<%= appName %>/)
* [Locales](https://webtranslateit.com/en/projects/id)


# Environments

* Integration: http://<%= appName %>-int.etereo.io/
